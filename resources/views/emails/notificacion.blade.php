                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <p style="line-height: 24px; margin-bottom:15px;">
                                            ...
                                            {{ $confemail->saludoinicial }}{{-- Estimado profesor(a), --}}
                                        ...
                                        <table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="table table-sm container590">
                                            <thead>
                                                <tr align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                              ...
                                              <tbody>
                                                ...
                                                <tr>
                                                  ...
                                                  <td>{{ $curso->asignatura ."-". $curso->descripcion }}</td>
                                                  <td>{{ $curso->seccion }}</td>
                                                  <td>{{ $curso->alumno ." - ". $curso->apellidos }}</td>
                                                </tr>
                                                @endforeach
                                        ...
                                        <p style="line-height: 24px">
                                            ...
                                            Atentamente,</br>
                                            {{ $confemail->firma }}{{-- REGISTROS ACADÉMICOS --}}
                                        </p>

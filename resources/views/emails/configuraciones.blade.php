                ...
                <form>    
                      <fieldset>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="asuntoEmail" aria-describedby="emailHelp" placeholder="Ingresa el asunto del email">

                        <label for="labelSaludoInicial">Saludo inicial</label>
                          <input type="text" class="form-control" id="saludoEmail" aria-describedby="emailHelp" placeholder="Ingresa el saludo inicial">


                        <label for="labelPrimerParrafo">Primer párrafo</label>
                        <textarea class="form-control" id="primerParrafoEmail" rows="3"></textarea> 

                        <label for="labelSegundoParrafo">Segundo párrafo</label>
                        <textarea class="form-control" id="primerParrafoEmail" rows="3"></textarea> 

                        <label for="labelSaludoFinal">Saludo final</label>
                        <input type="text" class="form-control" id="saludoEmail" aria-describedby="emailHelp" placeholder="Ingresa el saludo final">

                        <label for="labelFirma">Firma</label>
                        <input type="text" class="form-control" id="firmaEmail" aria-describedby="emailHelp" placeholder="Ingresa la firma del mensaje">
